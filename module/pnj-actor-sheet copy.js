  ...
  activateListeners(html) {
    ...
    html.find(".item-delete").click((ev) => {
      ...
      let dialog_item_delete = new Dialog({
        ...
        content:
          "<div class='card-header'><center><span class='bouton_texte'>Êtes vous sûr ?</span></div>&nbsp",
        buttons: {
          non: {
            label: "NON",
            callback: () => (supItem = 0),
        ...
        let dialog_ardence_choix = new Dialog(
          {
            ...
            content:
              "<div class='card-header'><center><span class='bouton_texte'>ARDENCE</span></div>&nbsp" +
              "<br><center><span class='bouton_texte'>Voulez-vous placer des points d'ardence ?</span><br><br>",
            buttons: {
              oui: {
                label: "NON",
                callback: () => (ardence = 0),
                  ...
                  let dialog_ardence = new Dialog(
                    {
                      ...
                      content:
                        ...
                        "<br><center><span class='bouton_texte'>Combien souhaitez-vous en placer ?</span><br><br>",
                      buttons: btns_ar,
                      //close: () => d.render(true)
                      close: function () {
                        if (ptardence !== "") {
        ...
        let dialog_DIFF = new Dialog(
          {
            title: label.toUpperCase(),
            content:
              "<div class='card-header'><center><span class='bouton_texte'>DIFF</span></div>&nbsp" +
              '<br><center><span class="bouton_texte">Sélectionnez la DIFF.</span><br><br>',
            buttons: buttons,
            default: "10",
            close: () => {
              if (diff !== "") {
        ...
        let dialog_BONUS = new Dialog(
          {
            title: label.toUpperCase(),
            content:
              "<div class='card-header'><center><span class='bouton_texte'>BONUS/MALUS</span></div>&nbsp" +
              "<br><center><span class='bouton_texte'>Sélectionnez le BONUS/MALUS à ajouter au pool</span><br><br>",
        ...
        dialog_DIFF = new Dialog(
          {
            ...
            content:
              "<div class='card-header'><center><span class='bouton_texte'>DIFF</span></div>&nbsp" +
              '<br><center><span class="bouton_texte">' +
              msg +
              "</span><br><br>",
      ...
      let dialog_DIFF = new Dialog(
        {
          ...
          content:
            "<div class='card-header'><center><span class='bouton_texte'>DIFF</span></div>&nbsp" +
            '<br><center><span class="bouton_texte">Sélectionnez la DIFF ou "DEF" pour que la DIFF soit égale à la DEF de la cible.</span><br><br>',
      ...
      let d0 = new Dialog(
        {
          title: talentName.toUpperCase(),
          content:
            "<div class='card-header'><center><span class='bouton_texte'>TEST</span></div>&nbsp" +
            "<br><center><span class='bouton_texte'>Quel type de TEST souhaitez-vous réaliser ?</span><br><br>",
          buttons: {
            talent: {
              label:
      ...
      let d = new Dialog(
        {
          title: talentName.toUpperCase(),
          content:
            "<div class='card-header'><center><span class='bouton_texte'>TRAIT</span></div>&nbsp" +
            "<br><center><span class='bouton_texte'>Quel TRAIT voulez-vous utiliser ?</span><br><br>",
          buttons: {
            aucun: {
      ...
      let d2 = new Dialog(
        {
          title: "SPE",
          content:
            "<div class='card-header'><center><span class='bouton_texte'>SPE associee</span></div>&nbsp" +
            "<br><center><span class='bouton_texte'>Voulez-vous utiliser une SPE ?</span><br><br>",
          buttons: btns,
          default: "non",
      ...
      let d4 = new Dialog(
        {
          ...
          content:
            "<div class='card-header'><center><span class='bouton_texte'>DIFF</span></div>&nbsp" +
            '<br><center><span class="bouton_texte">Sélectionnez la DIFF ou "NC" si elle n\'est pas communiquée</span><br><br>',
          buttons: generateDiffButtons(4, 27),
          default: "NC",
      ...
      let d_diff = new Dialog(
        {
          title: "DIFF",
          content:
            "<div class='card-header'><center><span class='bouton_texte'>DIFF</span></div>" +
            '<br><center><span class="bouton_texte">Sélectionnez la DIFF ou "NC" si elle n\'est pas communiquée</span><br><br>',
          buttons: generateDiffButtons(4, 27),
          default: "NC",
          close: () => {
      ...
      let choix = new Dialog(
        {
          title: traitName,
          content:
            "<div class='card-header'><center><span class='bouton_texte'>TYPE DE TEST<span></div>&nbsp" +
            "<br><center><span class='bouton_texte'>Quel type de TEST souhaitez-vous réaliser ?</span><br><br>",
          buttons: {
            duel: {
              label: "DUEL",
      ...
      let d = new Dialog(
        {
          title: traitName,
          content:
            "<div class='card-header'><center><span class='bouton_texte'>TRAIT N°2<span></div>&nbsp" +
            "<br><center><span class='bouton_texte'>Quel TRAIT voulez-vous utiliser ?</span><br><br>",
          buttons: {
            vivacite: {
              label: "VIVACITE",
      ...
      let d2 = new Dialog(
        {
          title: traitName,
          content:
            "<div class='card-header'><center><span class='bouton_texte'>DOMAINE</span></div>&nbsp" +
            "<br><center><span class='bouton_texte'>Quel DOMAINE voulez-vous utiliser ?</span><br><br>",
          buttons: {
            COMMUNICATION: {
              label: "COMMUNICATION",
