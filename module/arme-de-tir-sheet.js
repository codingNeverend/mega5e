...
export class Arme_de_Tir_Sheet extends foundry.appv1.sheets.ItemSheet {
  /** @override */
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["mega", "sheet", "item"],
      template: "systems/mega/templates/arme-de-tir-sheet.html",
      width: 549,
      height: 709,
      tabs: [
        {
  ...
  activateListeners(html) {
    ...
    html.find(".upload_file").click((ev) => {
      console.log("avant update" + this.object.system.effet_arme.value);
      let myfile = document.getElementById("myfile").value;
      let fichier = myfile.split("\\");
      let prefixe = "modules/JB2A_DnD5e/Library/Generic/Weapon_Attacks/Ranged/";
      fichier = prefixe + fichier[2];
      console.log("fichier :" + fichier);
      this.object.update({ "system.effet_arme.value": fichier });
    });
